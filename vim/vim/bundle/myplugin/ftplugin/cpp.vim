...
iabbr <buffer> class class<SPACE>{<ESC>dda;<ESC>Opublic:<CR><C-R>=EatChar('\s')<CR>
...
iabbr <buffer> fori {<ESC>ddki<SPACE><LEFT>for<SPACE>(int i = 0; ; ++i<C-o>F;<C-R>=EatChar('\s')<CR>
